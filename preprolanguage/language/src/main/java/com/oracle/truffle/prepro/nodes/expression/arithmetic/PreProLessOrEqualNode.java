 ...
 */
@NodeInfo(shortName = "<=")
public abstract class PreProLessOrEqualNode extends PreProBinaryNode {

    @Specialization
    @TruffleBoundary
    protected PreProScalar lessOrEqual(PreProScalar left, PreProScalar right) {
        return left.isLessOrEqualThan(right);
    }
