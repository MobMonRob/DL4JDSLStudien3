 ...
 */
@NodeInfo(shortName = ">=")
public abstract class PreProGreaterOrEqualNode extends PreProBinaryNode {

    @Specialization
    @TruffleBoundary
    protected PreProScalar greaterOrEqual(PreProScalar left, PreProScalar right) {
        return left.isGreaterOrEqualThan(right);
    }
