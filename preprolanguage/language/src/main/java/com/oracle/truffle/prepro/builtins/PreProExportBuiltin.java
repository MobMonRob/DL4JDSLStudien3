...
/**
 * Built-in function that goes through to export a symbol to the polyglot bindings.
 */
@NodeInfo(shortName = "export")
public abstract class PreProExportBuiltin extends PreProBuiltinNode {

    @Specialization
    public Object exportSymbol(String symbol,
                               Object value,
                               @CachedContext(PreProLanguage.class) PreProContext context) {
        try {
            context.getEnv().exportSymbol(symbol, value);
            return value;
