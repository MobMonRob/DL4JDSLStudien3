...
/**
 * The base class of all Truffle nodes for PrePro. All nodes (even expressions) can be used as
 * statements, i.e., without returning a value. The {@link VirtualFrame} provides access to the
 * local variables.
 */
@NodeInfo(language = "PrePro", description = "The abstract base node for all PrePro statements")
@GenerateWrapper
@ReportPolymorphism
public abstract class PreProStatementNode extends Node implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new PreProStatementNodeWrapper(this, probe);
    }
