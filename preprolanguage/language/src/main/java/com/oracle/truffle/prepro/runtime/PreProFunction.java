...
import com.oracle.truffle.prepro.nodes.PreProUndefinedFunctionRootNode;

import java.util.logging.Level;

/**
 * Represents a PrePro function. On the Truffle level, a callable element is represented by a
 * {@link RootCallTarget call target}. This class encapsulates a call target.
 * <p>
 * The {@link #callTarget} can be {@code null}. To ensure that only one {@link PreProFunction} instance
 * per name exists, the {@link PreProFunctionRegistry} creates an instance also when performing name
 * lookup. A function that has been looked up, i.e., used, but not defined, has a call target that
 * encapsulates a {@link PreProUndefinedFunctionRootNode}.
 */
@ExportLibrary(InteropLibrary.class)
public final class PreProFunction implements TruffleObject {

    public static final int INLINE_CACHE_SIZE = 2;

    private static final TruffleLogger LOG = TruffleLogger.getLogger(PreProLanguage.ID, PreProFunction.class);
    ...
    protected PreProFunction(PreProLanguage language, String name) {
        this.name = name;
        this.callTarget = Truffle.getRuntime().createCallTarget(new PreProUndefinedFunctionRootNode(language, name));
    ...
    abstract static class Execute {
         ...
         *
         * <p>
         * Caching the call target and using a {@link DirectCallNode} allows
         * Truffle to perform method inlining.
         * </p>
         *
         * <p>
        ...
        protected static Object doDirect(PreProFunction function, Object[] arguments,
        ...
        protected static Object doIndirect(PreProFunction function, Object[] arguments,
                                           @Cached IndirectCallNode callNode) {
            /*
             * PrePro has a quite simple call lookup: just ask the
             * function for the current call target, and call it.
             */
