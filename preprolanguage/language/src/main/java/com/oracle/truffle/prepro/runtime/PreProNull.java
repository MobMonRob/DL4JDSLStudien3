...
/**
 * A null value. Used in PrePro only as a default return
 * value from a function without a return statement.
 */
@ExportLibrary(InteropLibrary.class)
@SuppressWarnings("static-method")
public final class PreProNull implements TruffleObject {

    /**
     * The canonical value to represent {@code null} in SL.
     */
    public static final PreProNull SINGLETON = new PreProNull();
    ...
    /**
     * {@link PreProNull} values are interpreted as null values by other languages.
     */
    @ExportMessage
    boolean isNull() {
        return true;
