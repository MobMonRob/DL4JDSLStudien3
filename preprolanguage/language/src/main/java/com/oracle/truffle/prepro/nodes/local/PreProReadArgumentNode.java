 ...
 */
public class PreProReadArgumentNode extends PreProExpressionNode {
    ...
    public PreProReadArgumentNode(int index) {
        this.index = index;
    }
    ...
    public Object executeGeneric(VirtualFrame frame) {
        ...
        if (index < args.length) {
            ...
            throw PreProException.parameterCountError(this, index);
        }
    }
}
