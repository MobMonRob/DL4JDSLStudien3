...
/**
 * PrePro node that performs the "X" (cross product) operation.
 * <p>
 * Cross Product can only be applied to two Vector3.
 */
@NodeInfo(shortName = "X")
public abstract class PreProCrossProductNode extends PreProBinaryNode {
