...
/**
 * Builtin function to write a value to the {@link PreProContext#getOutput() standard output}. The
...
public abstract class PreProPrintBuiltin extends PreProBuiltinNode {
    ...
    @Specialization
    public String print(String value, @CachedContext(PreProLanguage.class) PreProContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
    ...
    @Specialization
    public Object print(Object value, @CachedContext(PreProLanguage.class) PreProContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
